...
class FantasticConsole {
  ...
  getFileDescriptionString(file = '', method = '', variable = '') {
    const browserStyledDescriptionString = [`%c${file} %c ${method}() %c${variable}:`, `color: ${browserColors.file}`, `color: ${browserColors.method}`, `color: ${browserColors.variable}`];
    const nodeDescriptionStyledString = [`${nodeColors.file}${nodeColors.method}${nodeColors.variable}`, `${file}`, ` ${method}()`, ` ${variable}:`];
